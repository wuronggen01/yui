...
! function() {
	...
	window.Framework7 = function(a) {
		...
		var d = function(e, a) {
			...
			l.triggerEvent = function(e, a, t) {
				...
				l.input.val("").trigger("change"), l.container.removeClass("searchbar-active searchbar-not-empty"), l.cancelButton.length > 0 && l.cancelButton.css(p, -l.cancelButton[0].offsetWidth + "px"), (l.searchList.length || l.params.customSearch) && l.overlay.removeClass("searchbar-overlay-active"), i.device.ios ? setTimeout(function() {
					e()
				}, 400) : e()
			}, l.clear = function() {
		...
		i.triggerPageCallbacks = function(e, a, t) {
			...
			function s() {
				...
				if (e.params.dynamicNavbar && "undefined" == typeof m && (m = c && 0 !== c.length ? !0 : !1), p.addClass("page-on-left").removeClass("cached"), m && (u = k.find(".navbar"), f = k.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
					var t, r;
					if (t = o(P[P.length - 2]), m && (r = o(t[0] && t[0].f7RelatedNavbar || f[f.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0) t.length && t[0] !== p[0] && t.addClass("cached"), m && r.length && r[0] !== c[0] && r.addClass("cached");
					else {
						var s = m && r.length;
					...
					P = S.children(".page:not(.cached)"), m && (f = k.find(".navbar-inner:not(.cached)")), e.history.indexOf(h) >= 0 ? e.history = e.history.slice(0, e.history.indexOf(h) + 2) : e.history[[e.history.length - 2]] ? e.history[e.history.length - 2] = h : e.history.unshift(h)
				}
		...
		i.modalStack = [], i.modalStackClearQueue = function() {
			...
			if (!0 !== e.data("f7-modal-shown")) {
				...
				})), n || r || s.addClass("modal-overlay-visible"), e.removeClass("modal-out").addClass("modal-in").transitionEnd(function(a) {
				...
				if (0 !== r.length) {
					...
					if (!(w.disabled || e.hasClass("disabled") || b.hasClass("disabled"))) {
						...
						var R = i._compiledTemplates.smartSelectItem,
							V = "";
						if (!g)
							for (var q = 0; q < D.length; q++) V += R(D[q]);
						...
						var F, G = i._compiledTemplates.smartSelectNavbar({
								pageTitle: d,
								backText: c,
								closeText: u,
								openIn: s,
							...
							Y = "",
							W = "";
						"page" === s ? (F = "static", e.parents(".navbar-through").length > 0 && (F = "through"), e.parents(".navbar-fixed").length > 0 && (F = "fixed"), W = e.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", Y = e.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + F) : F = "fixed";
						...
						var J, Q = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + B + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + j + '"><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel">' + _ + '</a></form><div class="searchbar-overlay"></div>',
							K = ("through" === F ? G : "") + '<div class="pages">  <div data-page="' + X + '" data-select-name="' + z + '" class="page smart-select-page ' + Y + " " + W + '">' + ("fixed" === F ? G : "") + (U ? Q : "") + '    <div class="page-content">' + ("static" === F ? G : "") + '      <div class="list-block ' + (g ? "virtual-list" : "") + " smart-select-list-" + B + " " + (m ? "theme-" + m : "") + '">        <ul>' + (g ? "" : V) + "        </ul>      </div>    </div>  </div></div>";
		...
		var v = function(e) {
			...
			t.activeIndex = t.params.initialSlide, t.openIndex = t.activeIndex, t.opened = !1, t.open = function(e) {
				...
				i.length > 0 && "pause" in i[0] && i[0].pause(), t.params.onTransitionStart && t.params.onTransitionStart(e)
			}, t.onSliderTransitionEnd = function(e) {
				t.params.zoom && y && e.previousIndex !== e.activeIndex && (x.transform("translate3d(0,0,0) scale(1)"), T.transform("translate3d(0,0,0)"), y = x = T = void 0, k = S = 1), t.params.onTransitionEnd && t.params.onTransitionEnd(e)
			}, t.layout = function(e) {
			...
			var M, I, O, E, L, D, B, N, A, z, H, R, V, q, F, G, Y, W = {},
				j = {};
			t.onSlideTouchStart = function(e) {
				...
				if (x && 0 !== x.length && (t.swiper.allowClick = !1, M && y)) {
					...
					if (!(a < t.swiper.width && n < t.swiper.height)) {
						...
						e.preventDefault(), e.stopPropagation(), I = !0, O = j.x - W.x + H, E = j.y - W.y + R, L > O && (O = L + 1 - Math.pow(L - O + 1, .8)), O > B && (O = B - 1 + Math.pow(O - B + 1, .8)), D > E && (E = D + 1 - Math.pow(D - E + 1, .8)), E > N && (E = N - 1 + Math.pow(E - N + 1, .8)), V || (V = j.x), G || (G = j.y), q || (q = Date.now()), F = (j.x - V) / (Date.now() - q) / 2, Y = (j.y - G) / (Date.now() - q) / 2, Math.abs(j.x - V) < 2 && (F = 0), Math.abs(j.y - G) < 2 && (Y = 0), V = j.x, G = j.y, q = Date.now(), T.transform("translate3d(" + O + "px, " + E + "px,0)")
					}
				}
				...
				if (x && 0 !== x.length) {
					...
					var a = 300,
						...
						s = Y * n,
						o = E + s;
					0 !== F && (a = Math.abs((i - O) / F)), 0 !== Y && (n = Math.abs((o - E) / Y));
					var l = Math.max(a, n);
					O = i, E = o;
					var p = A * k,
						d = z * k;
			...
			return p.setValue = function(e, a) {
				...
				if (!f.divider) {
					...
					f.setValue = function(e, a, n) {
						...
						}(n || "undefined" == typeof n) && (f.value = i.attr("data-picker-value"), f.displayValue = f.displayValues ? f.displayValues[e] : f.value, r !== e && (f.onChange && f.onChange(p, f.value, f.displayValue), p.updateValue()))
	...
	window.Dom7 = e, Framework7.prototype.support = function() {
				...
				if ("" !== o)
					if (o.indexOf("{{") < 0) i.push({
						...
						for (r = 1; r < l.length; r++) {
							var f = l[r];
							e(f) ? u[f[0]] = "false" === f[1] ? !1 : f[1] : c.push(f)
						}
						if (o.indexOf("{#") >= 0) {
							var m, h = "",
								g = "",
							...
							for (r = n + 1; r < s.length; r++)
								if (s[r].indexOf("{{#") >= 0 && C++, s[r].indexOf("{{/") >= 0 && C--, s[r].indexOf("{{#" + p) >= 0) h += s[r], b && (g += s[r]), v++;
								...
								v--, h += s[r], b && (g += s[r])
							} else s[r].indexOf("else") >= 0 && 0 === C ? b = !0 : (b || (h += s[r]), b && (g += s[r]));
							w && (m && (n = m), i.push({
								type: "helper",
								helperName: p,
								contextName: c,
		...
		var f = this;
		f.version = "3.0.8", f.params = t, f.classNames = [];
		var m;
		if (m = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e, m && (f.$ = m, f.container = m(a), 0 !== f.container.length)) {
			...
			f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push("swiper-container-" + f.params.direction), f.params.freeMode && f.classNames.push("swiper-container-free-mode"), f.support.flexbox || (f.classNames.push("swiper-container-no-flexbox"), f.params.slidesPerColumn = 1), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push("swiper-container-3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push("swiper-container-" + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0, f.params.setWrapperSize = !1), "fade" === f.params.effect && (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, "undefined" == typeof d && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = m(f.params.pagination), f.params.paginationClickable && f.paginationContainer.addClass("swiper-pagination-clickable")), f.rtl = n() && ("rtl" === f.container[0].dir.toLowerCase() || "rtl" === f.container.css("direction")), f.rtl && f.classNames.push("swiper-container-rtl"), f.rtl && (f.wrongRTL = "-webkit-box" === f.wrapper.css("display")), f.params.slidesPerColumn > 1 && f.classNames.push("swiper-container-multirow"), f.device.android && f.classNames.push("swiper-container-android"), f.container.addClass(f.classNames.join(" ")), f.translate = 0, f.progress = 0, f.velocity = 0, f.lockSwipeToNext = function() {
				...
				for (e = 0; e < f.slides.length; e++) {
					...
					if (f.params.slidesPerColumn > 1) {
						var u, m, h;
						"column" === f.params.slidesPerColumnFill ? (m = Math.floor(e / l), h = e - m * l, (m > d || m === d && h === l - 1) && ++h >= l && (h = 0, m++), u = m + h * s / l, c.css({
							...
							"margin-top": 0 !== h && f.params.spaceBetween && f.params.spaceBetween + "px"
						}).attr("data-swiper-column", m).attr("data-swiper-row", h)
					}
					"none" !== c.css("display") && ("auto" === f.params.slidesPerView ? o = n() ? c.outerWidth(!0) : c.outerHeight(!0) : (o = (f.size - (f.params.slidesPerView - 1) * a) / f.params.slidesPerView, n() ? f.slides[e].style.width = o + "px" : f.slides[e].style.height = o + "px"), f.slides[e].swiperSlideSize = o, f.slidesSizesGrid.push(o), f.params.centeredSlides ? (t = t + o / 2 + r / 2 + a, 0 === e && (t = t - f.size / 2 - a), Math.abs(t) < .001 && (t = 0), i % f.params.slidesPerGroup === 0 && f.snapGrid.push(t), f.slidesGrid.push(t)) : (i % f.params.slidesPerGroup === 0 && f.snapGrid.push(t), f.slidesGrid.push(t), t = t + o + a), f.virtualSize += o + a, r = o, i++)
				}
				...
				if (!f.params.centeredSlides) {
					...
					f.snapGrid = g, Math.floor(f.virtualSize - f.size) > Math.floor(f.snapGrid[f.snapGrid.length - 1]) && f.snapGrid.push(f.virtualSize - f.size)
				}
			...
			f.onTouchStart = function(e) {
				...
				if (!f.params.allowSwipeToNext && i < f.translate && i < f.minTranslate()) return !1;
				if (!f.params.allowSwipeToPrev && i > f.translate && i > f.maxTranslate()) return !1;
				...
				load: function() {
					...
					if (f.params.watchSlidesVisibility) f.wrapper.children("." + f.params.slideVisibleClass).each(function() {
						...
						for (e = f.activeIndex; e < f.activeIndex + f.params.slidesPerView; e++) f.slides[e] && f.lazy.loadImageInSlide(e);
					else f.lazy.loadImageInSlide(f.activeIndex);
					if (f.params.lazyLoadingInPrevNext)
						if (f.params.slidesPerView > 1) {
							for (e = f.activeIndex + f.params.slidesPerView; e < f.activeIndex + f.params.slidesPerView + f.params.slidesPerView; e++) f.slides[e] && f.lazy.loadImageInSlide(e);
							for (e = f.activeIndex - f.params.slidesPerView; e < f.activeIndex; e++) f.slides[e] && f.lazy.loadImageInSlide(e)
						} else {
