                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on July 16, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Top 10 Destinations</a></h4>
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on July 13, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Follow Your Dreams</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on July 6, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Travel &amp; Work</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on July 21, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Sleep Better</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on June 5, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Black &amp; White</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
                        ...
                        <div class="row items-push">
                            ...
                            <div class="col-md-8">
                                <div class="font-s12 push-10">
                                    ...
                                    <a href="base_pages_profile.php"><?php $one->get_name(); ?></a> on June 1, 2015
                                </div>
                                <h4 class="text-uppercase push-10"><a class="text-primary-dark" href="frontend_blog_story.php">Exploring the Alps</a></h4>
                                <p class="push-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ultrices, justo vel imperdiet gravida, urna ligula hendrerit nibh, ac cursus nibh..</p>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" href="javascript:void(0)"><i class="fa fa-share-alt push-5-r"></i> Share</a>
                                    <a class="btn btn-default" href="frontend_blog_story.php">Continue Reading..</a>
            ...
            <div class="col-md-4">
                ...
                <a class="block block-link-hover3" href="base_pages_profile.php">
                    ...
                    <div class="block-content block-content-full text-center">
                        <div>
                            <?php $one->get_avatar(1, 'female', 96); ?>
                        </div>
                        ...
                        <ul class="list list-simple">
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="frontend_blog_story.php">Exploring the Alps</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="frontend_blog_story.php">Travel &amp; Work</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="frontend_blog_story.php">Black &amp; White</a>
                                </div>
                            ...
                            <li>
                                <div class="push-5 clearfix">
                                    ...
                                    <a class="font-w600" href="base_pages_profile.php"><?php $one->get_name(); ?></a> on <a href="frontend_blog_story.php">Sleep Better</a>
                                </div>
